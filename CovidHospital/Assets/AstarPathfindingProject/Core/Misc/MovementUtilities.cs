...
namespace Pathfinding.Util
{
    public static class MovementUtilities
    {
	    ...
	    /// <param name="slowdownFactor">
	    ///     Value between 0 and 1 which determines how much slower the character should move than normal.
	    ///     Normally 1 but should go to 0 when the character approaches the end of the path.
	    /// </param>
	    /// <param name="slowWhenNotFacingTarget">
	    ...
	    /// <summary>
	    ///     Calculate an acceleration to move deltaPosition units and get there with approximately a velocity of
	    ///     targetVelocity
	    /// </summary>
            ...
            Vector2 forwardsVector)
        {
            ...
            else
            {
                ...
                var targetPoint = deltaPosition - normalizedTargetVelocity *
                    Math.Min(TargetVelocityWeight * distance * targetSpeed / (currentSpeed + targetSpeed),
