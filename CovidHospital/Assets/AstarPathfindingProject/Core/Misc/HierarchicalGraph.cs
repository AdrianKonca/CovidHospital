...
namespace Pathfinding
{
	...
	public class HierarchicalGraph
    {
        ...
        private readonly Stack<int> freeNodeIndices = new Stack<int>();
        ...
        private readonly Queue<GraphNode> temporaryQueue = new Queue<GraphNode>();
        private readonly Stack<int> temporaryStack = new Stack<int>();
