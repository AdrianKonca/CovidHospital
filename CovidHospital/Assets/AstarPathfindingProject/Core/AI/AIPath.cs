...
namespace Pathfinding
{
    ...
    public partial class AIPath : AIBase, IAstarAI
    {
            ...
            out Quaternion nextRotation)
        {
            ...
            if (
                    updatePosition) // Get our current position. We read from transform.position as few times as possible as it is relatively slow
            ...
            if (interpolator.valid && !isStopped)
            {
                ...
                if (reachedEndOfPath &&
                    whenCloseToDestination == CloseToDestinationMode.Stop) // Slow down as quickly as possible
