...
namespace Pathfinding
{
    ...
    public class Seeker : VersionedMonoBehaviour
    {
        ...
        [FormerlySerializedAs("graphMask")] private int graphMaskCompatibility = -1;
        ...
        private void OnPathComplete(Path p, bool runModifiers, bool sendCallbacks)
        {
            ...
            if (
                !path.error &&
                runModifiers) // This will send the path for post processing to modifiers attached to this Seeker
                RunModifiers(ModifierPass.PostProcess, path);
