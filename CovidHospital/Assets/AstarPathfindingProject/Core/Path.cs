...
namespace Pathfinding
{
    ...
    public abstract class Path : IPathInternals
    {
        ...
        ///     See: <see cref="Seeker.IsDone" /> which also takes into account if the %path %callback has been called and had
        ///     modifiers applied.
        /// </summary>
        public bool IsDone()
        {
        ...
        private readonly List<object> claimed = new List<object>();
