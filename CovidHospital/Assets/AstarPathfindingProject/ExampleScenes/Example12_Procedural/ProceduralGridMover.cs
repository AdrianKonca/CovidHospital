...
namespace Pathfinding
{
	...
	///     increase the 'diameter' setting under the Grid Graph Settings -> Collision Testing header to achieve a similar
	///     effect.
    ...
    public class ProceduralGridMover : VersionedMonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (graph == null) throw new Exception("The AstarPath object has no GridGraph or LayeredGridGraph");
            UpdateGraph();
        }
                ...
                for (var l = 0; l < layers; l++)
                {
                    ...
                    for (var z = 0; z < depth; z++)
                    {
                        ...
                        for (var x = xmin; x < xmax; x++)
                        {
                            ...
                            if (
                                    node !=
                                    null) // Clear connections on all nodes that are wrapped and placed on the other side of the graph.
