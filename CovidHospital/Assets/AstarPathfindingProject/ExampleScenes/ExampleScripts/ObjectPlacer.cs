...
namespace Pathfinding.Examples
{
    ...
    public class ObjectPlacer : MonoBehaviour
    {
	    /// <summary>
	    ///     GameObject to place.
	    ///     When using a Grid Graph you need to make sure the object's layer is included in the collision mask in the GridGraph
	    ///     settings.
	    /// </summary>
        ...
        public void PlaceObject()
        {
            ...
            {
                var p = hit.point;
                var obj = Instantiate(go, p, Quaternion.identity);
