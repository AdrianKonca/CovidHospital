...
namespace Pathfinding.Util
{
    ...
    {
        private readonly Stack<Mesh> cachedMeshes = new Stack<Mesh>();
        private readonly HashSet<ulong> existingHashes = new HashSet<ulong>();

        /// <summary>Material to use for the navmesh outline in the editor</summary>
        public Material lineMaterial;

        private readonly List<MeshWithHash> meshes = new List<MeshWithHash>();

        /// <summary>Material to use for the navmesh in the editor</summary>
        public Material surfaceMaterial;

        private readonly HashSet<ulong> usedHashes = new HashSet<ulong>();
        ...
        public void ClearCache()
        {
            ...
            while (cachedMeshes.Count > 0) Object.DestroyImmediate(cachedMeshes.Pop());
